...
TBLOCK_INFO::TBLOCK_INFO(int paket_i,int TB_i,double gen_time)
{
	paket_id = paket_i;
...
void TBLOCK_INFO::Increase_TransTimes()
{
	transmit_times++;
}

int TBLOCK_INFO::Get_TransTimes()
{
	return transmit_times;
}

void TBLOCK_INFO::Clear()
{
	paket_id = -1;
...
void TBLOCK_INFO::Set_MCS(int CQI_index)
{
...
void TBLOCK_INFO::Set_TBsize(int RB_num)
{
